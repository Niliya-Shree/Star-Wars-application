...
describe('Character Modal', () => {
  ...
  it('should show character details in modal when opened', () => {
    ...
    expect(modal).toHaveTextContent('172 cm');
    expect(modal).toHaveTextContent('77 kg');
    expect(modal).toHaveTextContent('19BBY');
  });
});
